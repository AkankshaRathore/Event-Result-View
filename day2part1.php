...
?>
    ...
    <tbody>
            ...
            <?php
echo '<tr class="even"><th>Day 0 theme events</th>';
            $sql_query = "Select marks from score where eventid = 50 ";
			...
			echo '<tr class="odd"><th>Day 1 events</th>';
           $ttl_arr = array();
        for($i = 1;$i<15;$i++){
            $tot = 0;
            for($j=1;$j<23;$j++){
